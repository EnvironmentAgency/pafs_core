...
RSpec.describe PafsCore::FinancialYearStep, type: :model do
  describe "attributes" do
    ...
    it "validates that :project_end_financial_year is 2017 or later" do
      subject.project_end_financial_year = 2016
      expect(subject.valid?).to be false
      expect(subject.errors[:project_end_financial_year]).to include "must be 2017 or later"
    end
