      ...
      def extract_data
        {
          ...
          pv_whole_life_benefits_duration_of_benefits:   sheet.cell('E', 39),
          pv_whole_life_benefits_people_related_impacts: sheet.cell('E', 42),

          economic_sumary_sheet_completed:               sheet.cell('K', 37),
          ...
          qualifying_benefits_outcome_measures: {
            om2_present_day: {
              before: {
                ...
                least_deprived_60: {
                  moderate_risk:          sheet.cell('G', 49),
                  intermediate_risk:      sheet.cell('H', 49),
                  significant_risk:       sheet.cell('I', 49),
                  very_significant_risk:  sheet.cell('J', 49)
                }
              },
              after: {
                most_deprived_20: {
                ...
                least_deprived_60: {
                  low_risk:               sheet.cell('F', 54),
                  moderate_risk:          sheet.cell('G', 54),
                  intermediate_risk:      sheet.cell('H', 54),
                  significant_risk:       sheet.cell('I', 54),
                  very_significant_risk:  sheet.cell('J', 54)
                }
              }
            },
            om2_in_2040: {
              before: {
                ...
                least_deprived_60: {
                  moderate_risk:          sheet.cell('G', 64),
                  intermediate_risk:      sheet.cell('H', 64),
                  significant_risk:       sheet.cell('I', 64),
                  very_significant_risk:  sheet.cell('J', 64)
                }
              },
              after: {
                most_deprived_20: {
                ...
                least_deprived_60: {
                  low_risk:               sheet.cell('F', 69),
                  moderate_risk:          sheet.cell('G', 69),
                  intermediate_risk:      sheet.cell('H', 69),
                  significant_risk:       sheet.cell('I', 69),
                  very_significant_risk:  sheet.cell('J', 69)
                }
              }
            },
            om3: {
              before_construction: {
                ...
                least_deprived_60: {
                  long_term_loss:         sheet.cell('F', 77),
                  medium_term_loss:       sheet.cell('G', 77),
                },
              }
            },
            om4: {
              net_change_hectares: {
                ...
                arable_land: {
                  low:    sheet.cell('D', 91),
                  medium: sheet.cell('E', 91),
                  high:   sheet.cell('F', 91),
                }
              },
              length_of_habitat_enhanced: {
                comprehensive_restoration_of_physical_modifications: sheet.cell('P', 85),
                partial_restoration_of_physical_modifications:       sheet.cell('P', 87),
                improvements_to_fish_passage:                        sheet.cell('P', 89)
              }
            }
          }
        }
